...
print("Vamos começar um desafio contra o ocmputador?")
print("Ganha quem conseguir fechar o Grid na coluna diagonal")
print(" jogue X ou O dentro do grid, não roube, primeiro você e logo em seguida eu com o oposto de um dos dois que vc jogar (O ou X)")
print("- - -")
print("- - -")
print("- - -")

print("escolha um número de 1 a 9 para sua joada conforme o grid a seguir!")
print("1 2 3")
print("4 5 6")
print("7 8 9")
...
if vencedor == 1:
  ...
  print ("Deu Velha ninguém perdeu e venceu, foi empate")
